  ...
  return (
      ...
      <main>
        ...
        <div className="container" id="intro-container">
          ...
          <div className="portrait-wrapper">
            <div id="self-portrait" alt="self-portrait"></div>
          </div>
          <p className="headline-2">I'm Kai.</p>
        </div>
        <div className="container" id="web-dev-container">
        ...
        <div className="container" id="contact-container">
          <div>
            ...
            <div id="touch-container">
              <p className="headline-1" id="touch-l">
                in
              </p>
              <p className="headline-1" id="touch-r">
                touch
              </p>
            </div>
	...
	L341.91,330.654L341.91,330.654z"
        ...
        <div id="imprint-container">
          <p className="headline-3" id="imprint-trigger">
            Imprint
          </p>
